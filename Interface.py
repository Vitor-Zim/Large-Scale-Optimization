...
def main():
    ...
    if uploaded_file is not None:
		...
		converter = MpsToLpConverter(mps_path=file_path)
		lp_path = converter.convert()

        st.session_state.file_path = lp_path
